...
I have simulated this by separating the test into a random sumbsample, and a leave one out atlethe sample. 
The accuracy of the prediction dropped from : xxx to xxx.
